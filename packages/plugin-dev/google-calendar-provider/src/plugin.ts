...
// Supply credentials from your own Google Cloud project for local development.
// Keep live OAuth credentials out of version control.
const CLIENT_ID = 'YOUR_GOOGLE_OAUTH_CLIENT_ID';
const CLIENT_SECRET = 'YOUR_GOOGLE_OAUTH_CLIENT_SECRET';
const MOBILE_CLIENT_ID = 'YOUR_ANDROID_OAUTH_CLIENT_ID';
const IOS_CLIENT_ID = 'YOUR_IOS_OAUTH_CLIENT_ID';
